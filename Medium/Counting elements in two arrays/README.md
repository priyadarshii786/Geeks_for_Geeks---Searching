...
<p><span style="font-size: 18px;"><strong>Expected Time Complexity:</strong> O(m + n).<br><strong>Expected Auxiliary Space:</strong>&nbsp;O(m).</span></p>
